  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        future: FirestoreServices.getPatientAppointment(widget.appointmentId),
        builder: (_, snapshot) {
          if (!snapshot.hasData) {
            return Center(
              child: Column(
            ...
            var apmt = snapshot.data!.data();

            return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              future: FirestoreServices.getAppointment(apmt!['docReference'], apmt['appointmentReference']),
              builder: (_, snapshot) {
                if (!snapshot.hasData) {
                  return Center(
                    child: Column(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                            future: FirestoreServices.getTargetUser(apmt['docReference']),
                            builder: (_, snapshot) {
                              if (!snapshot.hasData) {
