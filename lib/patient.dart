          ...
          children: [
                ...
                builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                  if (snapshot.hasData && snapshot.data!.exists) {
                    ...
                    return Column(
                      children: [
                        Padding(
                          padding: const EdgeInsets.fromLTRB(25.0, 30.0, 12.0, 20),
                          child: Align(
                        ...
                        Padding(
                          padding: const EdgeInsets.fromLTRB(25.0, 0, 12.0, 20.0),
                          child: Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
            ...
            const Padding(
              padding: EdgeInsets.fromLTRB(
                  25.0, 30.0, 12.0, 20.0), // add padding to top, left, and right
              child: Align(
                alignment: Alignment.centerLeft,
                child: Text(
                  'Doctors',
